...
const metrics = [["전체 매물", "12"], ["판매중", "9"], ["신규 문의", "3"], ["검토 대기 신고", "2"]];
  ...
  return (
    <div className="bg-surface-muted px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-7 text-sm font-semibold text-brand">ADMIN</p><h1 className="mt-1 text-3xl font-bold text-text-primary">장터 운영 현황</h1><p className="mt-2 text-sm text-text-secondary">매물, 문의, 신고 상태를 확인하고 우선 검수 대상을 관리합니다.</p>
