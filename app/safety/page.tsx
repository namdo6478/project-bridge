  ...
  return (
    <div className="bg-surface-muted px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-6 rounded-2xl border border-border bg-white p-6 sm:p-8"><h2 className="text-xl font-bold text-text-primary">누구에게 확인해야 하나요?</h2><div className="mt-5 grid gap-3 sm:grid-cols-3"><div className="rounded-xl bg-surface-muted p-4"><p className="font-bold text-brand">판매자</p><p className="mt-2 text-sm leading-relaxed text-text-secondary">가격, 재고, 장비 상태, 시운전, 운송·설치 조건</p></div><div className="rounded-xl bg-surface-muted p-4"><p className="font-bold text-brand">장터 운영자</p><p className="mt-2 text-sm leading-relaxed text-text-secondary">허위·중복·도용·금지 매물의 숨김·삭제 신고</p></div><div className="rounded-xl bg-red-50 p-4"><p className="font-bold text-red-800">금융기관·경찰</p><p className="mt-2 text-sm leading-relaxed text-red-900">송금 피해, 사기·협박 등 범죄가 의심되는 상황</p></div></div></section>
