  ...
  return (
    <div className="bg-surface-muted px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 text-sm leading-relaxed text-text-secondary">운영정책을 위반한 매물만 신고해 주세요. 신고는 판매자에게 바로 공개하지 않고 매물 유지·숨김·삭제 검수에만 사용합니다.</p>
        <div className="mt-5 grid gap-3 sm:grid-cols-3"><div className="rounded-xl border border-border bg-white p-4"><p className="text-xs font-bold text-brand">판매 여부·가격</p><p className="mt-2 text-xs leading-relaxed text-text-secondary">판매자에게 직접 확인</p></div><div className="rounded-xl border border-border bg-white p-4"><p className="text-xs font-bold text-brand">계약·환불 분쟁</p><p className="mt-2 text-xs leading-relaxed text-text-secondary">거래 당사자 간 해결</p></div><div className="rounded-xl border border-red-200 bg-red-50 p-4"><p className="text-xs font-bold text-red-800">허위·사기 의심</p><p className="mt-2 text-xs leading-relaxed text-red-900">관계기관 신고 후 매물 신고</p></div></div>
